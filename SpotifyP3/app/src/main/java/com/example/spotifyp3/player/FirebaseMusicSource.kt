...
import com.example.spotifyp3.utils.remote.MusicDatabase
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO){
        ...
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                ...
                .putString(METADATA_KEY_DISPLAY_ICON_URI, song.albumUrl)
                .putString(METADATA_KEY_MEDIA_URI,song.songUrl)
                .putString(METADATA_KEY_ALBUM_ART_URI, song.albumUrl)
